...
> ORACLE_HOSTNAME 是否来自环境变量 $HOSTNAME ?
...
打印 Oracle Net Services configuration successful. The exit code is 0，说明运行成功；在 /usr/local/oracle/product/11.2.0/network/admin 中生成 listener.ora 和 sqlnet.ora
...
> TOTALMEMORY 应保留默认值 800，不然调整 memory_target，启动时报 ORA-00838: Specified value of MEMORY_TARGET is too small 或 ORA-00845: MEMORY_TARGET not supported on this system
