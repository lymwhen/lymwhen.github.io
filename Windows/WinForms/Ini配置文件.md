...
> [C#读写INI文件 - 钱恩基 - 博客园 (cnblogs.com)](https://www.cnblogs.com/xiesong/p/10320893.html)

```c#
IniUtils.Read("system", "url", "about:blank")
```
...
namespace jds_win
{
    class IniUtils
    {
        ...
        {
            StringBuilder sb = new StringBuilder(1024);
            GetPrivateProfileString(section, key, def, sb, 1024, configIni);
            return sb.ToString();
        }
        ...
        {
            //CheckPath(filePath);
            return WritePrivateProfileString(section, key, value, configIni);
        }
        ...
        {
            return Write(section, null, null, configIni);
        }
        ...
        {
            return Write(section, key, null, configIni);
        }
    }
}
