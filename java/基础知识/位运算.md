...
可见 byte 事实上可以存储 0-255 的数字，存储超过 byte 范围的 128-255 时，二进制位与我们期待的一致，只是需要使用无符号的方式将其转换出来
...
> [java将byte转为无符号字节——解决java没有unsigned byte问题_龙之竹的博客-CSDN博客_java无符号byte](https://blog.csdn.net/qq_37372007/article/details/103102650)
